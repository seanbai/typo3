...
return [
    'ctrl' => [
		...
		'searchFields' => '',
        'iconfile' => 'EXT:login/Resources/Public/Icons/tx_login_domain_model_login.gif'
    ],
    'interface' => [
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table' => 'tx_login_domain_model_login',
                'foreign_table_where' => 'AND tx_login_domain_model_login.pid=###CURRENT_PID### AND tx_login_domain_model_login.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
