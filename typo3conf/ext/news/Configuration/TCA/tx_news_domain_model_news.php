...
$tx_news_domain_model_news = [
    ...
    'columns' => [
        ...
        'type' => [
            ...
            'config' => [
                ...
                'items' => [
                    ...
                    [$ll . 'tx_news_domain_model_news.type.I.1', 1, 'ext-news-type-external'],
                    [$ll . 'tx_news_domain_model_news.type.I.2', 2, 'ext-news-type-internal'],
                ],
                'showIconTable' => true,
                'size' => 1,
                'maxitems' => 1,
        ...
        'selecttype' => [
            'exclude' => false,
            'label' => $ll . 'tx_news_domain_model_news.selecttype',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'items' => [
    ...
    'palettes' => [
        ...
        'paletteCore' => [
            'showitem' => 'istopnews, selecttype, sys_language_uid, hidden,',
        ],
        'paletteNavtitle' => [
