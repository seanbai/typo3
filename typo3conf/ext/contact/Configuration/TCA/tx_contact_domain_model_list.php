...
return [
    'ctrl' => [
		...
		'searchFields' => 'firstname,lastname,email,subject,message,createtime',
        'iconfile' => 'EXT:contact/Resources/Public/Icons/tx_contact_domain_model_list.gif'
    ],
    'interface' => [
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, firstname, lastname, email, subject, message, createtime',
    ],
    'types' => [
		'1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, firstname, lastname, email, subject, message, createtime'],
    ],
    'columns' => [
		'sys_language_uid' => [
			'exclude' => true,
